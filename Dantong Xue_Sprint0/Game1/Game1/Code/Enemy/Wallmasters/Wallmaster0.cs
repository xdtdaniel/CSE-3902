...
namespace Game1.Enemy
{
    class Wallmaster0 : IEnemy
    {
        ...
        public void UpdateEnemy(Game1 game)
        {
            ...
            if (MovingState == 1 && Location.X < 48 * scale)
            {
                Direction = 1;
                MovingStateTimer++;
            }
            ...
            if (MovingState == 2 && MovingStateTimer < 16 * 5)
            {
                Direction = 1;
                MovingStateTimer++;
            }
        ...
        private bool PlayerInAttackingRange(Game1 game)
        {
            ...
            if (playerRectangle.X <= 102 * scale)
            {               
