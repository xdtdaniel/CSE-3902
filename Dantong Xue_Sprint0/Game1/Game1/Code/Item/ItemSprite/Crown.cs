...
namespace Game1.Code.Item.ItemSprite
{
    class Crown : IItemSprite
    {
        ...
        public Crown(int position_x, int position_y)
        {
            Texture = ItemFactory.ItemSpriteFactory.createCrown();
            TotalFrames = 2;
            Rows = 1;
            Columns = 2;
            CurrentFrame = 0;
        ...
        {
            width = 8 * (int)LoadAll.Instance.scale*3;
            height = 16 * (int)LoadAll.Instance.scale*2;
