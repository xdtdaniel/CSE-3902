...
LoadEnemy and MouseEnemyController were mainly written by Jason. LoadItem were mainly written by Zhihan. LoadAll, LoadMap, and MouseMapController.cs were mainly written by Dantong.
...
MouseEnemyController switches enemies from the storage mentioned earlier. In the most updated version, it has been integrated to MouseMapController.